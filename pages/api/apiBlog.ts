...
export async function getAllPostsForHome(preview: any = false) {
...
export async function getPostAndMorePosts(slug: string, preview: boolean, previewData: any = false) {
  ...
  const { data } = await fetchAPI<PostAndMorePosts>(
    `
